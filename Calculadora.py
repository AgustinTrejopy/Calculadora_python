...
boton_parentesisizq = Button(ventana, text = "(", width = 5, height = 2, command = lambda: click_boton("("))
boton_parentesisder = Button(ventana, text = ")", width = 5, height = 2, command = lambda: click_boton(")"))
...
#Agregado de botones en la pantalla

boton_borrar.grid(row = 1, column = 0, padx = 5, pady = 5)
boton_parentesisizq.grid(row = 1, column =  1, padx = 5, pady = 5)
boton_parentesisder.grid(row = 1, column =  2, padx = 5, pady = 5)
